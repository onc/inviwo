...
//*** Bidirectional Iteration ***\\
    ...
    /** Walk forward */
    ChannelIterator& operator++() { Index++; return this; }
...
/** Increment randomly */
template<typename T>
ChannelIterator<T> operator+(ind offset, ChannelIterator<T>& iter) { return ChannelIterator(iter.Parent, iter.Index + offset); }
